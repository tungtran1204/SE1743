        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="password-creation" method="post">
                    ...
                    <p>Enter nickname and password to register</p><input name="accountDetailName" type="text" placeholder="Name">

                    <input name="accountPassword" type="password" placeholder="Password" />
